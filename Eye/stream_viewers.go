...
func prepareStreamViewersBody(id uint64) (io.Reader, error) {
...
func loadStreamViewersPage(id uint64) (ViewersPageUserData, error) {
...
func loadStreamViewers(id uint64) ViewersPageUserData {
